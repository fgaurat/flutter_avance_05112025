...
class _TodoService implements TodoService {
  _TodoService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<TodoModel> fetchTodo(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TodoModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${id}',
    ...
    late TodoModel _value;
    try {
      _value = TodoModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
